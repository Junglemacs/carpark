...
<body>
	...
	<fieldset class="boxBody">
	 ...
	 <label>From:</label>
	<input type="text" name="from"value="<?php echo date("m/d/Y"); ?> <?php date_default_timezone_set('Africa/Nairobi'); echo date("h:ia"); ?>">
	<label>To:</label>
	<input type="text" name="to" value="<?php echo date("m/d/Y"); ?> <?php  date_default_timezone_set('Africa/Nairobi');echo date("h:ia"); ?>"">
