...
<body>
	...
	<hr />
	   ...
	   <select name="street" class="cjComboBox" >
			<option value="CITY HALL">CITY HALL - Cars and P.S.V</option>
			<option value="KIJABE STREET">KIJABE STREET - Lorries and Trucks </option>
			<option value="ENGEN STREET">ENGEN STREET - Lorries and Trucks</option>
			<option value="MAMA NGINA STREET">MAMA NGINA STREET - Cars and P.S.V</option>
		</select>
	...
	<input type="text" name="account" placeholder="Transaction Number" required title="Credit card number" maxlength="14"/> 
	 
	   <label>Note: Parking Fees: Ksh. 300/- per day</label>
	</fieldset>
	<footer>
